...
public class EmailUtils {
    public static void sendEmail(User user) {
        //发送方
        String myAccount = "y543938801@163.com";
        //授权码
        String myPass = "EZKDWUASUHXWUZFE";
        //发件人 邮箱的 SMTP 服务器地址
    ...
    private static MimeMessage createMsg(Session session, String myAccount, User user) {
        ...
        try {
            ...
            String url = "http://" + ip + ":6060/user?method=active&c=" + Base64Utils.encode(user.getU_code());
            //设置邮件正文 setContent 可以使用html标签
            message.setContent(user.getU_name() + ",你好<br>欢迎注册小米商城! 请点击链接进行激活:<a href='" + url + "'>点击此处</a>", "text/html;charset=utf-8");
            //设置邮件的发送时间 是立即发送
